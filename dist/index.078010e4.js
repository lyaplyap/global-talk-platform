const CARDS_MOCK = [
    {
        ...
        description: [
            ...
            "The teacher remarked on how quickly the students were learning. L'enseignant a not\xe9 la rapidit\xe9 avec laquelle les \xe9l\xe8ves apprenaient."
        ]
    },
    {
...
const getCardHTML = ({ imageSrc, review, word, synonym, transcription, description })=>{
    return `
    <div class="card">
...
const insertCards = (cards)=>{
    ...
    if (cardsNode) cardsNode.append(...getCardNodes(cards));
};
document.addEventListener("DOMContentLoaded", ()=>insertCards(CARDS_MOCK));

//# sourceMappingURL=index.078010e4.js.map
